<template>
	...
	>
		...
		<view v-if="uri" class="uni-flex uni-row" style="width: 50%;flex-direction: column;position: relative;">
			<u-avatar  :src="uri" ></u-avatar>
		<text
			class="u-radio__text u-radio__uri"
...
<style lang="scss">
	...
	.u-radio {
		...
		&__uri{
			...
			top: 10px;font-size: 18px;font-weight: bold;
		}
	}
</style>
