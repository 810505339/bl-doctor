<template>
  <view class="famous_doctor">
    <view class="search_id">
      ...
      <view @click="initIndex(1)" :class="{'address': true, 'active': index===1}"  class="mar">
        <u-cell-group>
      ...
      <view @click="initIndex(2)" :class="{'address': true, 'active': index===2}"  class="mar">接诊最多</view>
...
import UnDetail from '../examination/unscramble/unDeatil.vue'
export default {
  components: {
    Address,
    UnDetail
