<template>
    <view class="content">
        ...
        <view class="input-box2" :class="popupLayerClass" @touchmove.stop.prevent="discard">
            <view class="voice">
                <u-icon name="/static/accompany-service/reduce.png" size="48"></u-icon>
            </view>
            <view class="textbox">
            ...
            <!-- 功能性按钮 -->
            <view class="flex u-p-l-20" @click="switchFun"  v-if="inputStatus == 0">
                <u-icon name="/static/accompany-service/add.png" size="48" color="#ff6a00"></u-icon>
            </view>
			<view class="flex u-p-l-20" v-else style="height: 45px;width: 45px;line-height: 45px;text-align: center;">
			    <text>发送</text>
			</view>
        </view>
        <!-- 抽屉栏 -->
        <view class="popup-layer" :class="popupLayerClass" @touchmove.stop.prevent="discard">
            ...
            <view class="emoji-swiper" :class="{hidden:hideEmoji}">
                <scroll-view scroll-y="true" style="height: 300rpx;">
                    <view class="u-p u-flex u-flex-wrap" style="display: flex;flex-wrap: wrap;">
                        <view class="u-m-b-32 emoji-box flex" v-for="(page,pid) in emojiList" :key="pid" @tap="clickEmoji(page)">
                            <image mode="widthFix" :src="'/static/chat/'+page.url"></image>
                        </view>
                    </view>
                </scroll-view>
            </view>
    ...
    data() {
        return {
            ...
            user_info:{
                ...
                headImg: "/static/accompany-service/avgatorDefault.png",
                id: 1,
                phone: "13535351112",
                pictureBanner: "/static/accompany-service/avgatorDefault.png",
            ...
            messageList: [
                {
                    ...
                    fromUserHeadImg: "/static/accompany-service/avgatorDefault.png",
                    fromUserId: 1,
                    hasBeenSentId: 1,
                    isItMe: true
                },{
                    ...
                    contentType: 1,
                    createTime: 1614069114032,
                    fromUserHeadImg: "/static/accompany-service/startservice.png",
                    fromUserId: 1,
                    hasBeenSentId: 2,
                    isItMe: false
                },{
